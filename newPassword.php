...
<body>
    ...
    <main class="main-container">
        <section class="signup-card">
            ...
            <div class="card">
                <h2 class="card__title" style="color: white;" id="FEP">Change Password</h2>
                <p style="color: white;" id="WSM">Enter New Password
                <br>
                ...
                <form action="" method="post">
                    ...
                    <button type="submit" class="submit-button" id="EM" name="change-password">Submit</button>
                </form>

                <p class="recaptcha-notification__text"><span id="T1">This page is protected by Google reCAPTCHA to
                        ensure
                        you're
                        not a bot.</span><button id="learn-more-btn" class="recaptcha-notification__link"
                        style="background-color: transparent; cursor: pointer;"
                        onmouseover="this.style.textDecoration='underline'"
                        onmouseout="this.style.textDecoration='none'" onclick="this.style.display='none'">Learn
                        More</button>
                <div id="additional-text" style="display: none;">
                    <p><span id="T2"> The information collected by Google reCAPTCHA is subject to the Google
                        </span><span>&nbsp;</span><a href="https://policies.google.com/privacy"
                            class="recaptcha-notification__link" id="PP"> Privacy Policy </a><span id="AD">and</span><a
                            href="https://policies.google.com/terms" class="recaptcha-notification__link" id="TS"> Terms
                            of Service</a><span id="T3">, and is used for
                            providing,
                            maintaining, and improving the reCAPTCHA service and for general security purposes (it is
                            not used for
    ...
    <script>
        ...
        function translateToArabic() {
            document.getElementById('FEP').textContent = 'تغيير كلمة المرور';
            document.getElementById('WSM').textContent = 'أدخل كلمة مرور جديدة';
            document.getElementById('PW').textContent = 'كلمة المرور';
            document.getElementById('CPW').textContent = 'تأكيد كلمة المرور';
            document.getElementById('EM').textContent = 'أرسال';
        ...
        function translateToEnglish() {
            document.getElementById('FEP').textContent = 'Change Password';
            document.getElementById('WSM').textContent = "Enter New Password";
            document.getElementById('PW').textContent = 'Password';
            document.getElementById('CPW').textContent = 'Confirm Password';
            document.getElementById('EM').textContent = 'Submit';
