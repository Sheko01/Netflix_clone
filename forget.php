...
if (isset($_POST['check-email'])) {
    ...
    if (mysqli_num_rows($run_sql) > 0) {
        ...
        if ($run_query) {
            ...
            $sender = "From: netflixsim2023@gmail.com";
...
<body>
  ...
  <main class="main-container">
    <section class="signup-card">
      ...
      <div class="card">
        <h2 class="card__title" style="color: white;" id="FEP">Forgot Email/Password</h2>
        <p style="color: white;" id="WSM">We will send you an email with instructions on how to reset your password.</p>
        <br>
        <?php
                        if(count($errors) > 0){
                            ?>
        ...
        <form action="" method="post">
          ...
          <button type="submit" class="submit-button" id="EM" name="check-email">Email Me</button>
        </form>
  ...
  <script>
    ...
    function translateToArabic() {
      document.getElementById('FEP').textContent = 'نسيت البريد الإلكتروني/ كلمة المرور';
      document.getElementById('WSM').textContent = 'سنرسل لك رسالة بريد إلكتروني تشتمل على إرشادات حول كيفية إعادة تعيين كلمة مرورك.';
      document.getElementById('EA').textContent = 'البريد الالكترونى';
      document.getElementById('EM').textContent = 'أرسل لي رسالة بريد إلكتروني';
    ...
    function translateToEnglish() {
      document.getElementById('FEP').textContent = 'Forgot Email/Password';
      document.getElementById('WSM').textContent = "We will send you an email with instructions on how to reset your password.";
      document.getElementById('EA').textContent = 'Email Address';
      document.getElementById('EM').textContent = 'Email Me';
